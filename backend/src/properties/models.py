...
class Property(models.Model):
    ...
    surface_total = models.FloatField(db_column='superficieTotal', blank=True, null=True)
    surface_useful = models.FloatField(db_column='superficieUtil', blank=True, null=True)
    surface_weighted = models.FloatField(db_column='superficiePonderada', blank=True, null=True)
    ...
    price = models.DecimalField(db_column='precio', max_digits=15, decimal_places=2, blank=True, null=True)
    uf_per_sqm = models.CharField(db_column='uf_m2', max_length=100, blank=True, null=True)
    bedrooms = models.IntegerField(db_column='habitaciones', blank=True, null=True)
    bathrooms = models.IntegerField(db_column='banos', blank=True, null=True)
    parking_spots = models.IntegerField(db_column='estacionamientos', blank=True, null=True)
    storage_units = models.IntegerField(db_column='bodegas', blank=True, null=True)
    # Multimedia y Geolocalización
    youtube_video_url = models.CharField(db_column='url', max_length=500, blank=True, null=True)
    latitude = models.FloatField(db_column='latitud', blank=True, null=True)
    longitude = models.FloatField(db_column='longitud', blank=True, null=True)
